...
If you install HAAI via pnpm (`pnpm add -g haai`), pnpm blocks dependency install scripts by default. Approve the native module builds once:
...
- **npm install:** `npm i -g haai@latest` (or `pnpm add -g haai@latest`)
